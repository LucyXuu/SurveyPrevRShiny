...
#' 
#' @param admin1.focus admin 1 name if were to create a state specific map
#'
...
prevMap.leaflet.alt.old <- function(res.obj,
                                gadm.shp ,
                                model.gadm.level,
                                strata.gadm.level =1,
                                admin1.focus = NULL,
  ...
  if(pseudo_level==2){
    ...
    if (!is.null(admin1.focus)) {
      gadm.shp <- gadm.shp[gadm.shp[[paste0('NAME_', strata.gadm.level)]] == admin1.focus, ]
...
prevMap.leaflet <- function(res.obj,
                            ...
                            model.gadm.level,
                            strata.gadm.level =1,
                            color.palette = NULL, # if vector of color code
                            value.to.plot = 'mean',
                            value.range = NULL,
                            num_bins=NULL,
                            legend.label = 'Estimates',
...
#rank plot heat map function in SUMMER
# app's UI
